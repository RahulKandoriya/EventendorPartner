...
import com.kandoriyatech.apps.eventendorpartner.adapters.acceptedLeads_adapter;
 ...
 */
public class AcceptedLeadsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_accepted_leads, container, false);
    ...
    private void loadRecyclerViewData() {
        ...
        try {
            ...
            adapter =  new acceptedLeads_adapter(list_items, getContext());
