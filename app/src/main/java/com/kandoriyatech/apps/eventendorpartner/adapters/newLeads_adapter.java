...
public class newLeads_adapter extends RecyclerView.Adapter<newLeads_adapter.ViewHolder> {

    private List<leads_item> listItems;
    private Context context;


    public newLeads_adapter(List<leads_item> listItems, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.new_leads_item, viewGroup, false);
