...
public class PhotoVIdeosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_photo_videos, container, false);
    ...
    private void loadRecyclerViewData() {
        ...
        try {
            ...
            for (int i = 0; i<50; i++) {
                 ...
                 gallery_item list_item = new gallery_item("let");

                listItems.add(list_item);

            }

            adapter =  new gallery_adapter(listItems, getContext());
